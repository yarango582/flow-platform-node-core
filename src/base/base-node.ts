...
export abstract class BaseNode<TInput, TOutput, TConfig>
  implements INode<TInput, TOutput, TConfig>
{
  ...
  static getMetadata(): NodeMetadata {
    throw new Error(
      "Static getMetadata() method must be implemented by node classes"
    );
  }
}
